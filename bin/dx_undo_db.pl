...
#
# Program Name : dx_undo_db.pl
# Description  : Undo refresh / rollback operation
...
for my $engine ( sort (@{$engine_list}) ) {
  ...
  for my $dbitem ( @{$db_list} ) {
    ...
    print "Going to undo last refresh / rollback operation on database - $groupname / $dbname\n";
