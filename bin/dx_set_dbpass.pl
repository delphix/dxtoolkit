...
=head1 SYNOPSIS
 ...
 dx_set_dbpass.pl [ -engine|d <delphix identifier> | -all ] [ -group group_name | -dbname db_name | -host host_name | -type dsource|vdb ] [-username <username>] -password <password> [ --help|? ] [ -debug ]
