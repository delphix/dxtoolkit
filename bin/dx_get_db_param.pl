...
for my $engine ( sort (@{$engine_list}) ) {
  ...
  my $db_list = Toolkit_helpers::get_dblist_from_filter($type, $group, $host, $dbname, $databases, $groups, $envname, $dsource, 'primary', undef, $debug);
  if (! defined($db_list)) {
