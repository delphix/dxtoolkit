...
#
# Program Name : Op_template_obj.pm
# Description  : Delphix Engine operation template object
...
sub new {
    ...
    my $dbonly = shift;
    my $debug = shift;
    logger($debug, "Entering Op_template_obj::constructor",1);
